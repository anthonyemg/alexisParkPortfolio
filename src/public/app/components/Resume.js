        ...
        <div className='page-wrapperBottom'>
          ...
          <div className='resume-wrapper'>
            <div className='resume-bottomText page-bottomText'>
              ...
              <span className='text-align-center' style={{fontSize:'28pt'}}>Alexis Park</span>
              ...
              <p>
                ...
                <br />
                <span style={{fontSize:'15pt'}}>•</span>
                <span style={{fontSize:'10pt'}}>Work in collaboration with product owners, analysts and engineers to lead UX/UI efforts for all Partner related projects.</span>
              </p>
              ...
              <p>
                ...
                <span style={{fontSize:'10pt'}}>
                  ...
                  <br />
                  • Wireframe, prototype. User-test proposed designs and interactions for desktop, iOS, and Android phone and tablet
                </span>
                <br />
                <span style={{fontSize:'10pt'}}>• Established and maintained interaction, visual and content pattern guide for Sam’s Club</span>
              </p>

              <p>
                <strong><span style={{fontSize:'12pt'}}>Assistant Instructor</span></strong>
                <br />
              ...
              <p>
                <strong><span style={{fontSize:'12pt'}}>User Experience Design Consultant</span></strong>
                <br />
                ...
                <br />
                <span style={{fontSize:'10pt'}}>• Create and deliver annotated wireframes for proposed design and direction. Create final UI mockups including specs</span>
                <br />
                <span style={{fontSize:'11pt'}}>Clients and Projects</span>
                <br />
                <span style={{fontSize:'10pt'}}>Agnitus, Publet, Minnovative Solutions, InstaVest, Mediakitz, Plannit.io, Anthology, and Qriously for redesigning the email marketing process, onboarding, site redesign, and various other projects</span>
              </p>

              <p>
                <strong><span style={{fontSize:'12pt'}}>:: SKILLS</span></strong>
                <br />
                <span style={{fontSize:'10pt'}}>User Research, Personas, Scenarios, User Flows, Storyboarding, Competitive Analysis, Card Sorting, A/ B Testing, Interaction Design, Prototyping, Usability Testing, Content Strategy, Information Architecture, Responsive Design, Sketching, Project Planning, Analytics, Lean UX, Agile UX, Wireframing</span>
                <br />
                <br />
                <strong><span style={{fontSize:'12pt'}}>:: TOOLS</span></strong>
                <br />
                <span style={{fontSize:'10pt'}}>Adobe Illustrator, Adobe Photoshop, Axure, Omnigraffle, Sketch, HTML/CSS, Framer.js, Flinto, Invision</span>
              </p>

              <p>
                <strong><span style={{fontSize:'12pt'}}>:: EDUCATION</span></strong>
                <br />
              ...
              <p>
                <strong><span style={{fontSize:'12pt'}}>:: LINKS</span></strong>
                <br />
                <span style={{fontSize:'10pt'}}>http://www.alexishpark.com  |  http://www.linkedin.com/in/alexispark</span>
              </p>
